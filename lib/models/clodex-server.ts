...
const CLODEX_SERVER_MODELS: readonly ClodexServerModel[] = [
  { key: "clodex:fast", name: "ErmaPro Aura", providerModel: "gemini-3.6-flash", maxTokens: 2048, envKey: "CLODEX_MODEL_FAST" },
  { key: "clodex:reasoning", name: "ErmaPro Lumen", providerModel: "gpt-5.6-luna", maxTokens: 6144, envKey: "CLODEX_MODEL_REASONING" },
  { key: "clodex:pro", name: "ProximaPro", providerModel: "kimi-k3", maxTokens: 8192, envKey: "CLODEX_MODEL_PRO" },
];
