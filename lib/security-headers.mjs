...
// Production no longer permits eval-like script execution. Inline scripts are
// retained temporarily for framework hydration compatibility and are observed
// under the stricter report-only policy below so nonce migration can be done
// without breaking production rendering.
