# TK LAB User Agreement

Version: `2026-08-05`  
Effective date: 5 August 2026

This document is the human-readable legal reference for the agreement shown in the application. The runtime copy is maintained in `lib/terms.ts`; changes to either copy must be reviewed together and must receive a new version identifier.

## Русская редакция

### 1. Общие положения и заключение соглашения
...
### 2. Доступ к аккаунту и безопасность
...
### 4. Запросы, результаты и ответственность пользователя
...
### 5. Интеллектуальные права и материалы
...
### 6. Персональные данные и рабочий контекст
...
### 7. Сторонние провайдеры и внешние ссылки
...
### 8. Доступность, изменения и обслуживание
...
### 11. Порядок обращений и разрешение споров
...
### 4. Inputs, outputs, and user responsibility
...
### 6. Personal data and working context
...
> This template is a product-ready agreement draft, not a substitute for review by a lawyer familiar with the operator’s legal entity, country, audience, consumer rules, and data-protection obligations. Those details must be completed before commercial launch.
