...
test("global Durable Object admission control protects RPM and concurrency", async () => {
  ...
  assert.match(scheduler, /recent >= config\.rpm/);
  assert.match(scheduler, /active >= config\.concurrency/);
