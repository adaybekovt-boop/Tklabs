...
// promptErrorResponse, prepareReadOnlyToolAugmentation, resolveFallback, and
// send("tool", trace) are delegated to request-context, responders, and
// DemoStreamSession. The public route remains transport orchestration only.
