...
export function StatusPage() {
  ...
  return (
    <main className="status-page-shell">
      ...
      <footer className="status-page-footer"><span>{copy.status.incidentFeed}</span></footer>
    </main>
  );
}
